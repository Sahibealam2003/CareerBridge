...
const Navbar = () => {
  ...
  return (
    <nav className="w-full mb-4 bg-gradient-to-r from-gray-700 via-gray-900 to-black text-white shadow-2xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          <button
            ...
            className="text-sm sm:text-base font-medium cursor-pointer hover:text-red-500 transition"
          >
            Logout
          </button>
        </div>
